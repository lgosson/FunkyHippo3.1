...
{
    public class FunkyHippoRepo<TEntity> : IFunkyHippoRepo<TEntity> where TEntity : class
    {
        internal FunkyHippoContext context;
        internal DbSet<TEntity> dbSet;

        public FunkyHippoRepo(FunkyHippoContext c)
        {
            context = c;
